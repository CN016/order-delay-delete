...
public @interface JsonFormat {
    ...
    public static class Value implements JacksonAnnotationValue<JsonFormat>, Serializable {
        ...
        public static JsonFormat.Value mergeAll(JsonFormat.Value... values) {
            ...
            JsonFormat.Value[] var2 = values;
            int var3 = values.length;

            for(int var4 = 0; var4 < var3; ++var4) {
                JsonFormat.Value curr = var2[var4];
                if (curr != null) {
        ...
        public static JsonFormat.Value forShape(JsonFormat.Shape sh) {
            return new JsonFormat.Value("", sh, (Locale)null, (String)null, (TimeZone)null, JsonFormat.Features.empty(), (Boolean)null);
        }

        public static JsonFormat.Value forLeniency(boolean lenient) {
            return new JsonFormat.Value("", (JsonFormat.Shape)null, (Locale)null, (String)null, (TimeZone)null, JsonFormat.Features.empty(), lenient);
        }
    ...
    public static class Features {
        ...
        public static JsonFormat.Features construct(JsonFormat.Feature[] enabled, JsonFormat.Feature[] disabled) {
            int e = 0;
            JsonFormat.Feature[] var3 = enabled;
            int var4 = enabled.length;

            int var5;
            for(var5 = 0; var5 < var4; ++var5) {
                JsonFormat.Feature f = var3[var5];
                e |= 1 << f.ordinal();
            }

            int d = 0;
            JsonFormat.Feature[] var9 = disabled;
            var5 = disabled.length;

            for(int var10 = 0; var10 < var5; ++var10) {
                JsonFormat.Feature f = var9[var10];
                d |= 1 << f.ordinal();
            }
        ...
        public JsonFormat.Features with(JsonFormat.Feature... features) {
            int e = this._enabled;
            JsonFormat.Feature[] var3 = features;
